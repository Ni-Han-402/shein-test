      ...
      <div>
        <nav className=" bg-gray-900 navbar py-0   max-w-[1080] mx-auto ">
          <div className=" flex justify-between">
            ...
            <div className="">
              <h1 className="lg:pr-5 md:pr-5  uppercase text-base md:text-2xl lg:text-3xl  font-bold text-white">
                Order-Grab Page
              </h1>
            </div>
          </div>
              ...
              <div className="card lg:card-side  shadow-xl bg-slate-300 ">
                ...
                <div className="card-body flex justify-center ">
                  <div>
                    ...
                    <div>
                      <p className=" mb-5">
                        Click the "Grab Order" button to get your profits for
                        each order you complete.
                      </p>
                    </div>
                  </div>
                  <div className="card-actions justify-end w-full">
                    {grabProductslogic != 0 ? (
                      <button
                        ...
                        onClick={grabOrder}
                        disabled={
                          user[0].total_grab == assetStats?.pack ? true : false
                        }
                      >
                        Grab Now
                      </button>
                      ...
                      <div className=" flex flex-col justify-between p-5   rounded-lg  bg-gradient-to-r from-cyan-500 to-blue-500 ... text-black  shadow-lg">
                        ...
                        <div className=" my-2 font-bold">
                          <p className="text-right">
                            {" "}
                            Orders left : {grabProducts.left_order}
                          </p>
                          <p className="text-left">
                            {" "}
                            Order Price :{" "}
                            {grabProducts.data.product.price1 == null
                              ? grabProducts.data.product.price
                              : grabProducts.data.product.price1}
                          </p>
                          <p className="text-right">
                            {" "}
                            Order Commision : {
                              grabProducts.data.commission
                            }{" "}
                            <img
                              className="inline ml-1 h-[20px] w-[20px]"
                              src={usdt}
                        ...
                        <div className="flex justify-center items-center">
                          <img
                            className="rounded-lg shadow-lg max-w-[200px] lg:max-w-[400px] md:max-w-[500px] "
                            alt=""
                            src={grabProducts.data.product.image}
                          />
                        </div>
